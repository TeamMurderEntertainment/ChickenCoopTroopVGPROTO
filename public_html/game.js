function startLogic()
{
	...
	function render()
	{
		...
		if (gameState == PLAYING || gameState == GAMEEND)
		{
			...
			console.log(chicken.x, canvas.width);
